...
def ej5():
    ...
    print('ingrese el primer componente del rango')
    inicio = int(input())
    print('ingrese el ultimo componente del rango')
    fin = int(input())  # fin....
...
def ej6():
    ...
    for numero in range(inicio,fin):
        if numero >= 0:
            suma += numero
            print('la suma de los positivo es:', suma)
        elif numero < 0:
            resta -= numero
            print('la resta de los negativos es:', -resta)
